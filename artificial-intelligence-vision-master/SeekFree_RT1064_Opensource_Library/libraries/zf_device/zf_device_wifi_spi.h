...
#else
#define WIFI_SPI_TARGET_IP "192.168.43.6" // 连接目标的 IP
#define WIFI_SPI_TARGET_PORT "3539"         // 连接目标的端口
#define WIFI_SPI_LOCAL_PORT "3939"          // 本机的端口 0：随机  可设置范围2048-65535  默认 6666
#endif
